...
<body>
		...
		<?php
		$query = "SELECT propiedades.nombre, propiedades.foto, propiedades.ciudad, propiedades.pais, propiedades.provincia, propiedades.direccion,hotsales.ID as ID_hotsales, hotsales.estado, hotsales.precio, hotsales.ID_propiedad as ID_propiedad, hotsales.lunes FROM `propiedades` INNER JOIN hotsales ON propiedades.ID = hotsales.ID_propiedad where hotsales.estado='HOTSALE'"; //consulta a la base con solo datos q necesito
